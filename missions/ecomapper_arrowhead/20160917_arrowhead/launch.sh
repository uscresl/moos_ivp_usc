...
LAWNMOWER="format=lawnmower,x=1850,y=930,width=400,height=200,lane_width=20,degs=0,startx=0,starty=0"
...
PILOT_LAWNMOWER_CONFIG="format=lawnmower,label=pilot-survey,x=1850,y=930,width=400,height=200,lane_width=100,degs=0,startx=0,starty=0"
...
SURVEY_DEPTH="10"
  ...
  WAYPOINTS1="2255,1035:2250,1035"
  MODEMID1="1"
  VTYPE1="UUV" # UUV, SHIP
