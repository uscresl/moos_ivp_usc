...
WAYPOINTS1="2250,1030:2250,1020:2255,1030"
#"format=lawnmower,x=2240,y=1030,width=20,height=20,lane_width=10,degs=0,startx=0,starty=0,rows=east-west,label=east-west-survey"
  MODEMID1="1"
  VTYPE1="UUV" # UUV, SHIP
  ...
  nsplug ecomapper_bhv.meta ecomapper.bhv -f VNAME=$VNAME1       \
      ...
      SURV_DEPTH_BHV=$SURVEY_DEPTH_BHV SURV_DEPTH=$SURVEY_DEPTHio--
fi
