...
//
double PositionInFormation::getDoubleFromNodeReport(std::string full_string, std::string key)
{
...
//
std::string PositionInFormation::getStringFromNodeReport(std::string full_string, std::string key)
{
...
void PositionInFormation::euclidDistance(double const x1, double const y1, double const x2, double const y2, double & euclid)
{
  double dx = x1 - x2;
  double dy = y1 - y2;
